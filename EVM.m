...
% Last Modified by GUIDE v2.5 15-Apr-2020 10:56:05
...
function EVM_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = EVM_OutputFcn(~, ~, handles) 
...
w=2*pi*1000; % radian value to creat 1 khz tone
...
global KEJRIWAL;
global AKHILESH;
set(handles.edit1,'String',MODI);
set(handles.edit3,'String',RAHUL);
set(handles.edit5,'String',KEJRIWAL);
set(handles.edit8,'String',AKHILESH);
set(handles.edit2,'String',100*MODI/(MODI+RAHUL+KEJRIWAL+AKHILESH));
set(handles.edit4,'String',100*RAHUL/(MODI+RAHUL+KEJRIWAL+AKHILESH));
set(handles.edit6,'String',100*KEJRIWAL/(MODI+RAHUL+KEJRIWAL+AKHILESH));
set(handles.edit9,'String',100*AKHILESH/(MODI+RAHUL+KEJRIWAL+AKHILESH));
set(handles.edit7,'String',MODI+RAHUL+KEJRIWAL+AKHILESH);
